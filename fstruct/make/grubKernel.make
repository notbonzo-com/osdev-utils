...
override DEFAULT_CC := /usr/bin/gcc
$(eval $(call DEFAULT_VAR,CC,$(DEFAULT_CC)))

override DEFAULT_LD := /usr/bin/ld
$(eval $(call DEFAULT_VAR,LD,$(DEFAULT_LD)))

override DEFAULT_AS := /usr/bin/as
...
override DEFAULT_CXX := /usr/bin/g++
...
../build/$(KERNEL): GNUmakefile $(OBJ) $(LIBC_OBJS)
	mkdir -p "$$(dirname $@)"
