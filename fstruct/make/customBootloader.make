...
override DEFAULT_OBJCOPY := ~/toolchain/x86_64-elf/bin/x86_64-elf-objcopy
...
../build/$(KERNEL): GNUmakefile cfg/linker.ld $(OBJ) $(LIBC_OBJS)
    ...
    @echo "$(ANSI_GREEN)OBJCOPY INTO A PE$(ANSI_RESET) $@"
    @$(DEFAULT_OBJCOPY) -I elf64-x86-64 -O efi-app-x86_64 $@ ../build/BOOTX64.EFI
